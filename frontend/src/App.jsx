...
function App() {
  ...
  // ÉTAT POUR LE MENU "OUTILS" (BOTTOM SHEET iOS)
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
          ...
          <div className="navbar-sidebar">
              ...
              {isMobile && (
                  <>
                      <div className={`nav-item ${activeTab === 'accueil' || activeTab === 'parametres' ? 'active' : ''}`} onClick={() => {setActiveTab('accueil'); setIsOutilsMenuOpen(false);}}>
                          <span className="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg></span>
                          <span>Bord</span>
                      </div>
                      <div className={`nav-item ${activeTab === 'caisse' ? 'active' : ''}`} onClick={() => {setActiveTab('caisse'); setIsOutilsMenuOpen(false);}}>
                          <span className="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg></span>
                          <span>Caisse</span>
                      </div>
                      <div className={`nav-item ${activeTab === 'agenda' ? 'active' : ''}`} onClick={() => {setActiveTab('agenda'); setIsOutilsMenuOpen(false);}} style={{position: 'relative'}}>
                          {(tachesIA || []).some(t => t.type_tache === 'CLIENT') && <span className="badge-ia-rouge"></span>}
                          <span className="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg></span>
                          <span>Agenda</span>
                      </div>
                      <div className={`nav-item ${activeTab === 'actions' ? 'active' : ''}`} onClick={() => {setActiveTab('actions'); setIsOutilsMenuOpen(false);}} style={{position: 'relative'}}>
                          {nbTachesUrgentes > 0 && <span className="badge-ia-rouge" style={{top: 0, right: '20px'}}></span>}
                          <span className="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg></span>
                          <span>Actions</span>
                      </div>
                      <div className={`nav-item ${isOutilsMenuOpen ? 'active' : ''}`} onClick={() => setIsOutilsMenuOpen(true)}>
                          <span className="nav-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/></svg></span>
                          <span>Outils</span>
                      </div>
                  </>
              )}
